...
public class Database {
    ...
    public static boolean userLogin(String username, String pass){
        try{
            ...
            String sql = "SELECT * FROM user WHERE username=\'"+username+"\' AND pass=MD5(\'"+pass+"\')";
    ...
    public static boolean userReg(String username, String pass){
        try{
            ...
            String sql = "INSERT INTO user VALUES (?,MD5(?),current_timestamp(), NULL)";
            PreparedStatement ps = conn.prepareStatement(sql);
    ...
    public static ResultSet select(String kode_brg){
        try{
            connect();
            stmt = conn.createStatement();
